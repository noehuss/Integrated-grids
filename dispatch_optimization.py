...
for key in technologies:
    costs_data.loc[key, 'CAPEX'] = utils.cost_conversion(costs_data.loc[key, 'CAPEX'], costs_data.loc[key, 'Currency year'])
    costs_data.loc[key, 'FOM'] = utils.cost_conversion(costs_data.loc[key, 'FOM'], costs_data.loc[key, 'Currency year'])
    costs_data.loc[key, 'VOM'] = utils.cost_conversion(costs_data.loc[key, 'VOM'], costs_data.loc[key, 'Currency year'])

for key, df in technologies.items():
    france_net.add_generator(key, costs_data.loc[key, 'CAPEX'], costs_data.loc[key, 'FOM'],
                            costs_data.loc[key, 'VOM'], costs_data.loc[key, 'Fuel'], costs_data.loc[key, 'Lifetime'],
                            costs_data.loc[key, 'Efficiency'], costs_data.loc[key, 'CO2'], df)
